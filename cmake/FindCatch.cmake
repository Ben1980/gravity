...
# Download specific file from catch2 git repository
function(_download_file name version destination_dir)
    message(STATUS "Downloading catch v${version}...")
    set(url https://github.com/catchorg/Catch2/releases/download/v${version}/${name})
...
function(_download_catch version destination_dir)
    _download_file("catch.hpp" ${Catch_FIND_VERSION} "${PROJECT_BINARY_DIR}/catch/")
endfunction()
